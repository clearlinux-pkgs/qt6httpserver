...
Version  : 6.8.0
Release  : 21
URL      : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qthttpserver-everywhere-src-6.8.0.zip
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qthttpserver-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qthttpserver-everywhere-src-6.8.0
cd %{_builddir}/qthttpserver-everywhere-src-6.8.0
pushd ..
cp -a qthttpserver-everywhere-src-6.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732607965
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qabstracthttpserver_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserver_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverhttp1protocolhandler_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverhttp2protocolhandler_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverliterals_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverrequest_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverresponder_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverresponse_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverrouter_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverrouterrule_p.h
/usr/include/QtHttpServer/6.8.0/QtHttpServer/private/qhttpserverstream_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6HttpServer.so.6.8.0
/usr/lib64/libQt6HttpServer.so.6
/usr/lib64/libQt6HttpServer.so.6.8.0
